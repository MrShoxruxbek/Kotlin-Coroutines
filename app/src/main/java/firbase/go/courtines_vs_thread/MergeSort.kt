...
//
//    @Test
//    fun `sort list of 4 elements`() {
//        listOf(1, 2, 3, 4).permuatations().forEach {
//            is.mergeSort() shouldEqual listOf(1, 2, 3, 4)
//        }
//    }
//
//    @Test
//    fun `can sort random list`() {
//        fun List<Int>.isSorted() = windowed(size = 2).all { it[0] <= it[1] }
//        val random = Random(seed = Random.nextInt().printed("seed = "))
//        val list = random.listOfInts(sizeRange = 0..100_000, valueRange = 0..50)
